//
//  HWYReportCardHtmlViewController.m
//  sutjwzxhwy
//
...
@interface HWYReportCardWebViewController ()

@end

@implementation HWYReportCardWebViewController
...
- (void)initNavBar {
    [self configTitleAndBackItem:@"成绩表"];
}
...
- (void)initView {
    ...
    [webView loadHtmlWithString:JWZX_REPORTCARD_URL success:^{
        [hud hide:YES];
    } failure:^{
        [hud hide:YES];
