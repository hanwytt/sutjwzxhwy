...
NSString *const MJRefreshHeaderStatePullingText = @"释放刷新";
NSString *const MJRefreshHeaderStateRefreshingText = @"刷新数据中...";

NSString *const MJRefreshFooterStateIdleText = @"点击加载更多";
NSString *const MJRefreshFooterStateRefreshingText = @"加载数据中...";
NSString *const MJRefreshFooterStateNoMoreDataText = @"加载完毕";